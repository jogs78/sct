        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            ...
                            <input type="text" class="form-control" id="residencia_add" placeholder="Clave de residencia...">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            ...
                            <input type="name" class="form-control" id="encargado_add" placeholder="Nombre del encargado...">
                ...
                <div class="modal-footer">
                    <button type="button" class="addr btn btn-success" data-dismiss="modal">
