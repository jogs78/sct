...
@section('contenido')
	<div class="row">
		<div class="col-md-12">	
			<ol class="breadcrumb breadcrumb-arrow">
		  		...
		  		<li><a href="{{ url('auxiliar/reporte') }}">Lista de pedidos</a></li>
    ...
    <div class="row">
    	<div class="col-md-4">
    		<div class="form-group">
    			...
    			<p id="pedido_id">{{ $pedidos->idpedido }}</p>
    		</div>
    	</div>
    	<div class="col-md-4">
    		<div class="form-group">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <a href="{{ url('auxiliar/reporte') }}" class="btn btn-info" role="button" data-toggle="tooltip" data-placement="top" title="Regresar"><span class="glyphicon glyphicon-chevron-left" ></span></a>

            <input type="submit" id="entregado" name="entregado" value="Entregado" class="btnentregado btn btn-success">
...
@section('scripts')
    {!! Html::script('plugins/bootstrap/js/EstadoAux.js') !!}
@endsection