...
@section('contenido')
    ...
    @include('delegado.pedidos.partials.search')
    
    <div class="row" id="pedidos">
        <div class="col-md-12 col-sm-12">
            <div class="table-responsive">
                <table class="table table-hover table-bordered table-striped table-condensed" id="consultar_reporte">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        @foreach($pedidos as $pe)
                            <tr class="item{{ $pe->idpedido }}">
                                ...
                                <td>
                                    <a data-toggle="tooltip" data-placement="top" title="Ver desgloce" class="btn btn-primary btn-sm" href="{{ URL::action('DelegadoController@Desgloce', $pe->idpedido) }}"><span class="glyphicon glyphicon-eye-open"></span> Ver</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
