        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <label for="cucop_delete">CUCOP</label>
                            <input type="text" id="cucop_delete" class="form-control" placeholder="CUCOP..." disabled>
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <label for="cambs_delete">Cambs</label>
                            <input type="text" id="cambs_delete" class="form-control" placeholder="Cambs..." disabled>
