        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <label for="cucop_edit">CUCOP</label>
                            <input type="text" id="cucop_edit" class="form-control" placeholder="CUCOP...">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <label for="cambs_edit">Cambs</label>
                            <input type="text" id="cambs_edit" class="form-control" placeholder="Cambs...">
