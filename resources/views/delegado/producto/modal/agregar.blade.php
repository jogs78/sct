        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <label for="cucop_add">CUCOP</label>
                            <input type="text" id="cucop_add" class="form-control" placeholder="CUCOP...">
                            <p class="errorCucop text-center alert alert-danger hidden"></p>
                        </div>
                    </div>

                    <div class="form-group">
                        <div class="col-sm-12">
                            <label for="cambs_add">Cambs</label>
                            <input type="text" id="cambs_add" class="form-control" placeholder="Cambs...">
                            <p class="errorCambs text-center alert alert-danger hidden"></p>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            ...
                            <input type="text" id="devolver_add" class="form-control" placeholder="SI / NO">
