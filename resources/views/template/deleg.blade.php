...
<head>
  ...
  <title>Almacén Central | @yield('title') </title>
    ...
    <!-- Collect the nav links, forms, and other content for toggling -->
      <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
        <ul class="nav navbar-nav">
          ...
          <li ><a href="{{ url('delegado/partida') }}">Partidas<span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-tags"></span></a></li>
          <li><a href="{{ url('delegado/reporte') }}">Reporte de pedidos<span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-list-alt"></span></a></li>
          <li ><a href="{{ url('delegado/residencia') }}">Residecias de obra<span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-flag"></span></a></li>
          <li ><a href="{{ url('delegado/asignar') }}">Asignar montos<span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-usd"></span></a></li>
          <li ><a href="{{ url('delegado/consolidado') }}">Consolidado<span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-list"></span></a></li>
        </ul>
      </div>
    </div>
  </nav>
