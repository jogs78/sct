...
<body>
    ...
    <!-- Collect the nav links, forms, and other content for toggling -->
      <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
        <ul class="nav navbar-nav">
          <li ><a href="{{ url('admin/inicio') }}">Inicio<span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-home"></span></a></li>
          <li><a href="{{ url('admin/users') }}">U s u a r i o s<span style="font-size:16px;" class="pull-right hidden-xs showopacity fa fa-users"></span></a></li>
        </ul>
      </div>
    </div>
  </nav>
  ...
  {!! Html::script('plugins/bootstrap/js/jquery-3.2.1.js') !!}
