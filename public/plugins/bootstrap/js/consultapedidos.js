               ...
               // console.log(vresponse);
                ...
                if (vresponse.length>0) {
                    ...
                    pintarPedidos(vresponse);
                     ...
                     var vhtml ='<p style="text-align:center" class="text-warning">';
                               vhtml+=' <strong>No existen pedidos registrados con este rango de fechas.</strong>';
                               vhtml+='</p>';
                  $("#pedidos").empty();
               ...
               html+='<tr>';
                    ...
                    html+="<tbody>";
                       ...
                       html+= '<td>'+ pedidos[i].descripcion +'</td>';
                        html+= '<td>';
                        html+=    '<a class="btn btn-primary btn-sm" href="desgloces/'+pedidos[i].idpedido+'"><span class="glyphicon glyphicon-eye-open"></span> Ver</a>';
